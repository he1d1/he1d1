...
export default defineConfig({
  markdown: {
    rehypePlugins: [rehypeHeadingIds, headingAnchor],
    shikiConfig: {
      theme: {
        name: "IBM Carbon Color Theme",
        type: "dark",
        colors: {
        ...
        tokenColors: [
          ...
          },
          {
            ...
            settings: {
              foreground: "#be95ff", // Purple 40
            },
          },
          {
            scope: "constant.language.boolean.true",
            settings: {
              foreground: "#42be65", // Green 40
            },
          },
          {
            scope: "constant.language.boolean.false",
            settings: {
              foreground: "#ff8389", // Red 40
            },
          },
          {
            scope: [
          ...
          // This created too much complexity to elements in markdown
          // {
          ...
          // I don't know if this part is necessary
          // {
          // 	"scope": "storage.type",
          // 	"settings": {
          // 		"foreground": "#be95ff" // Purple 40
...
/**
 * Rehype plugin to add prepend anchor tags to headings
 */
function headingAnchor() {
  return function (tree) {
    ...
    function visit(node, index, parent) {
      ...
      node.children?.forEach((child, index) => visit(child, index, node));
    }
